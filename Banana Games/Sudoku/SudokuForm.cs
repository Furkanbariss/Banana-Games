    ...
    public partial class SudokuForm : Form
    {
        ...
        private void BtnSolve_Click(object sender, EventArgs e)
        {
            if (grid == null || grid.IsGridEmpty())
            {
                ...
                lblStatus.Text = FormConstants.PuzzleGridEmpty;
                messageTimer.Start();
                return;
            }

            // Grid boyutunu kontrol et
            if (grid.Cells == null || grid.Cells.Count != grid.TotalRows * grid.TotalColumns)
            {
                lblStatus.ForeColor = Color.Red;
                lblStatus.Text = "Grid boyutu geçersiz!";
                messageTimer.Start();
                return;
            }
            ...
            {
                lblStatus.ForeColor = Color.Red;
                lblStatus.Text = "Grid çözülürken bir hata oluştu!";
            }
